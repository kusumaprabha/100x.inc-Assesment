# Save this script as create_voicebot.py
# Then run it to generate the voicebot_standalone.py file

with open('voicebot_standalone.py', 'w', encoding='utf-8') as f:
...
print("File 'voicebot_standalone.py' has been created successfully!")
print("Run: python voicebot_standalone.py")